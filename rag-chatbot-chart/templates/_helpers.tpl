...
helm.sh/chart: {{ include "rag-chatbot.chart" . }}
{{ include "rag-chatbot.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "rag-chatbot.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{- default (include "rag-chatbot.fullname" .) .Values.serviceAccount.name -}}
{{- else -}}
